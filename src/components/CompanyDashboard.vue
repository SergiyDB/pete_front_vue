  ...
  <div class="q-pa-md">
    ...
    <div class="row full-width q-py-lg">
      ...
      <div>
        ...
        <div style="cursor: pointer;" class="text-body2"><q-icon name="notifications"/>You have 12 new messages</div>
      </div>
      <q-space />
    ...
    <q-tab-panels v-model="tab" animated>
      <q-tab-panel v-if="user.user_role === 'admin'" name="overview">
        ...
        <section class="row q-col-gutter-md q-mb-lg">
          <div v-for="(elem, idx) in companyOverviewAverageIndicatorData" :key="idx" class="col-12 col-md-3">
      ...
      <q-tab-panel name="level">
        <section class="row q-col-gutter-md q-mb-lg">
          ...
          <div v-for="(elem, idx) in companyLevelAverageIndicatorData" :key="idx" class="col-12 col-md-3">
            <AverageIndicatorCard
              :data="elem"
            />
          </div>

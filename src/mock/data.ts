...
export const schoolOverviewAverageIndicatorData: Record<
  string,
  AverageIndicatorData
> = {
  'ave-cefr': {
  ...
  today: [
    {
      name: 'Pablo Batista',
      description:
        '~P3T3 8:00AM ~Andres Gonzales 11:00AM ~Pablo Batista 11:15AM',
    },
    {
      name: 'Andres Castro',
...
export const schoolGradeAverageIndicatorData: Record<
  string,
  AverageIndicatorData
> = {
  'ave-cefr': {
...
export const schoolOverviewSimpleIndicatorsData: Record<
  string,
  SimpleIndicatorData
> = {
...
export const schoolGradeSimpleIndicatorsData: Record<
  string,
  SimpleIndicatorData
> = {
...
export const companyOverviewAverageIndicatorData: Record<
  string,
  AverageIndicatorData
> = {
  'ave-cefr': {
  ...
  today: [
    {
      name: 'Alex Johnson',
      description:
        '~P3T3 8:00AM ~Maria Rodriguez 11:00AM ~Alex Johnson 11:15AM',
    },
    {
      name: 'Lucas Brown',
      description: '~P3T3 9:00AM',
...
export const companyLevelAverageIndicatorData: Record<
  string,
  AverageIndicatorData
> = {
  'ave-cefr': {
...
export const companyOverviewSimpleIndicatorsData: Record<
  string,
  SimpleIndicatorData
> = {
...
export const companyLevelSimpleIndicatorsData: Record<
  string,
  SimpleIndicatorData
> = {
